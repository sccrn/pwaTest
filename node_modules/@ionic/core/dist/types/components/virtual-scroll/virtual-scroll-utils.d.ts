...
export declare type NodeHeightFn = (node: VirtualNode, index: number) => number;
...
export declare function doRender(el: HTMLElement, itemRender: ItemRenderFn, dom: VirtualNode[], updateCellHeight: Function): void;
