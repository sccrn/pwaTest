...
export class Tab {
    ...
    static get properties() { return { "active": { "type": Boolean, "attr": "active", "mutable": true }, "badge": { "type": String, "attr": "badge" }, "badgeStyle": { "type": String, "attr": "badge-style" }, "btnId": { "type": String, "attr": "btn-id" }, "component": { "type": "Any", "attr": "component" }, "delegate": { "type": "Any", "attr": "delegate" }, "disabled": { "type": Boolean, "attr": "disabled" }, "el": { "elementRef": true }, "getTabId": { "method": true }, "href": { "type": String, "attr": "href" }, "icon": { "type": String, "attr": "icon" }, "label": { "type": String, "attr": "label" }, "name": { "type": String, "attr": "name" }, "selected": { "type": Boolean, "attr": "selected", "mutable": true, "watchCallbacks": ["selectedChanged"] }, "setActive": { "method": true }, "show": { "type": Boolean, "attr": "show" }, "tabsHideOnSubPages": { "type": Boolean, "attr": "tabs-hide-on-sub-pages" } }; }
