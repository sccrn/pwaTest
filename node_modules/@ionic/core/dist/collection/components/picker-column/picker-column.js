...
export class PickerColumnCmp {
    ...
    render() {
        ...
        results.push(h("ion-gesture", { canStart: this.canStart.bind(this), onStart: this.onDragStart.bind(this), onMove: this.onDragMove.bind(this), onEnd: this.onDragEnd.bind(this), gestureName: 'picker-swipe', gesturePriority: 10, type: 'pan', direction: 'y', passive: false, threshold: 0, attachTo: 'parent' }), h("div", { class: 'picker-opts', style: { maxWidth: col.optionsWidth } }, options.map((o, index) => h("button", { class: { 'picker-opt': true, 'picker-opt-disabled': o.disabled }, "disable-activated": true, onClick: () => this.optClick(event, index) }, o.text))));
        if (col.suffix) {
