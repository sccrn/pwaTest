export class RouteRedirect {
    ...
    static get properties() { return { "from": { "type": String, "attr": "from" }, "to": { "type": "Any", "attr": "to" } }; }
    static get events() { return [{ "name": "ionRouteRedirectChanged", "method": "ionRouteRedirectChanged", "bubbles": true, "cancelable": true, "composed": true }]; }
}
