export class MenuButton {
    ...
    render() {
        ...
        return (h("ion-menu-toggle", { menu: this.menu, autoHide: this.autoHide },
            h("ion-button", null, this.custom
                ? h("slot", null)
                : h("ion-icon", { slot: 'icon-only', name: menuIcon }))));
    }
    static get is() { return "ion-menu-button"; }
    static get host() { return { "theme": "menu-button" }; }
    static get properties() { return { "autoHide": { "type": Boolean, "attr": "auto-hide" }, "config": { "context": "config" }, "el": { "elementRef": true }, "menu": { "type": String, "attr": "menu" } }; }
