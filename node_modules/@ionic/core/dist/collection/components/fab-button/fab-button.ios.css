...
.fab-button-ios {
  ...
  -webkit-transition: 0.2s -webkit-transform cubic-bezier(0.25, 1.11, 0.78, 1.59);
  transition: 0.2s -webkit-transform cubic-bezier(0.25, 1.11, 0.78, 1.59);
  transition: 0.2s transform cubic-bezier(0.25, 1.11, 0.78, 1.59);
  transition: 0.2s transform cubic-bezier(0.25, 1.11, 0.78, 1.59), 0.2s -webkit-transform cubic-bezier(0.25, 1.11, 0.78, 1.59); }
...
.fab-translucent-ios {
  background-color: rgba(var(--ion-color-ios-primary-rgb, var(--ion-color-primary-rgb, 56, 128, 255)), 0.9);
  -webkit-backdrop-filter: saturate(180%) blur(20px);
  backdrop-filter: saturate(180%) blur(20px); }

.fab-translucent-ios-in-list {
  background-color: rgba(var(--ion-background-ios-color-rgb, var(--ion-background-color-rgb, 255, 255, 255)), 0.8); }
...
.fab-translucent-ios-secondary {
  background-color: rgba(var(--ion-color-ios-secondary-rgb, var(--ion-color-secondary-rgb, 12, 209, 232)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-tertiary {
  background-color: rgba(var(--ion-color-ios-tertiary-rgb, var(--ion-color-tertiary-rgb, 112, 68, 255)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-success {
  background-color: rgba(var(--ion-color-ios-success-rgb, var(--ion-color-success-rgb, 16, 220, 96)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-warning {
  background-color: rgba(var(--ion-color-ios-warning-rgb, var(--ion-color-warning-rgb, 255, 206, 0)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-danger {
  background-color: rgba(var(--ion-color-ios-danger-rgb, var(--ion-color-danger-rgb, 240, 65, 65)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-light {
  background-color: rgba(var(--ion-color-ios-light-rgb, var(--ion-color-light-rgb, 244, 245, 248)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-medium {
  background-color: rgba(var(--ion-color-ios-medium-rgb, var(--ion-color-medium-rgb, 152, 154, 162)), 0.9);
  opacity: .8; }
...
.fab-translucent-ios-dark {
  background-color: rgba(var(--ion-color-ios-dark-rgb, var(--ion-color-dark-rgb, 34, 36, 40)), 0.9);
  opacity: .8; }
